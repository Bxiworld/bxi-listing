...
const statusConfig = {
  ...
  'Review': { label: 'In Review', className: 'pending', color: 'bg-blue-100 text-blue-700' },
  'In Review': { label: 'In Review', className: 'pending', color: 'bg-blue-100 text-blue-700' },
  'indraft': { label: 'In Review', className: 'pending', color: 'bg-blue-100 text-blue-700' },
  'Indraft': { label: 'In Review', className: 'pending', color: 'bg-blue-100 text-blue-700' },
