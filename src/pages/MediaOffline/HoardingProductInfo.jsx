        ...
        try {
          ...
          const mappedData = jsonData.map((row, index) => {
            ...
            return {
              ...
              landmark: str(cellByNorm(row, 'Landmark', 'Traffic', 'traffic', 'Landmark*', 'Traffic*', 'traffic*'), row.Landmark, row.Traffic, row.traffic),
              state: str(row['State*'], row.State, row.state) || selectedState,
              city: str(row['City*'], row.City, row.city),
              latitude: str(cellByNorm(row, 'Latitude', 'Lat', 'lat', 'Latitude*', 'Lat*', 'lat*'), row.Latitude, row.Lat, row.lat),
